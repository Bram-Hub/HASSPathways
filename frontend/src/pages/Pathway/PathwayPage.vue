    ...
    <v-container>
        ...
        <v-container v-show="showGraph">
            <div id="graphView">
                <div class="graph-fab-container">
                    <v-btn color="grey" elevation="2" fab aria-label="Show class description on hover"
        ...
        <v-container v-show="!showGraph">
            <div class="fab-container">
                <v-btn color="light grey" elevation="2" fab aria-label="Switch to nex tab on class selection"
                ...
                <v-btn color="red" elevation="2" fab aria-label="Clear courses" @click="deselectCourses()">
            ...
            <v-tabs-items v-model="tab" touchless>
                <v-tab-item v-for="(item, index) in classTabs" :key="item[1]" :eager="true">
                    <CourseTable :ref="index" :courses="courses[item[1]]" :pathway-id="pathwayID" :show-desc="true"
