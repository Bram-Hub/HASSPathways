        ...
        >
          ...
          <v-expansion-panel>
            ...
            <v-expansion-panel-content color="white">
              <v-card-subtitle class="pb-0 pl-1">
                <v-chip
                  v-if="currentCourse.first_course.fields.major_restrictive"
                  medium
                  color="red"
                  class="mr-2 mt-2"
                  text-color="white"
                ...
                <v-chip
                  v-if="currentCourse.first_course.fields.CI"
                  medium
                  color="black"
                  class="mr-2 mt-2"
                  text-color="white"
                ...
                <v-chip
                  v-if="currentCourse.first_course.fields.HI"
                  medium
                  color="#87AEE8"
                  class="mr-2 mt-2"
                  text-color="black"
                ...
                <v-chip
                  v-if="currentCourse.first_course.fields.DI"
                  medium
                  color="#ff63bc"
                  class="mr-2 mt-2"
                  text-color="black"
                ...
                <v-chip
                  v-if="currentCourse.first_course.fields.fall"
                  medium
                  color="#ff8247"
                  class="mr-2 mt-2"
                  text-color="black"
                ...
                <v-chip
                  v-if="currentCourse.first_course.fields.spring"
                  medium
                  color="#54ff7c"
                  class="mr-2 mt-2"
                  text-color="black"
                ...
                <v-chip
                  v-if="currentCourse.first_course.fields.summer"
                  medium
                  color="#ffeb54"
                  class="mr-2 mt-2"
                  text-color="black"
          ...
          <v-expansion-panel class="mt-3">
            ...
            <v-expansion-panel-content color="white">
              <v-card-subtitle class="pb-0 pl-1">
                <v-chip
                  v-if="currentCourse.second_course.fields.major_restrictive"
                  medium
                  color="red"
                  class="mr-2 mt-2"
                  text-color="white"
                ...
                <v-chip
                  v-if="currentCourse.second_course.fields.CI"
                  medium
                  color="black"
                  class="mr-2 mt-2"
                  text-color="white"
                ...
                <v-chip
                  v-if="currentCourse.second_course.fields.HI"
                  medium
                  color="#87AEE8"
                  class="mr-2 mt-2"
                  text-color="black"
                ...
                <v-chip
                  v-if="currentCourse.second_course.fields.DI"
                  medium
                  color="#ff63bc"
                  class="mr-2 mt-2"
                  text-color="black"
                ...
                <v-chip
                  v-if="currentCourse.second_course.fields.fall"
                  medium
                  color="#ff8247"
                  class="mr-2 mt-2"
                  text-color="black"
                ...
                <v-chip
                  v-if="currentCourse.second_course.fields.spring"
                  medium
                  color="#54ff7c"
                  class="mr-2 mt-2"
                  text-color="black"
                ...
                <v-chip
                  v-if="currentCourse.second_course.fields.summer"
                  medium
                  color="#ffeb54"
                  class="mr-2 mt-2"
                  text-color="black"
          ...
          <v-expansion-panel class="mt-3">
            ...
            <v-expansion-panel-content color="white">
              <v-card-subtitle class="pb-0 pl-1">
                <v-chip
                  v-if="currentCourse.third_course.fields.major_restrictive"
                  medium
                  color="red"
                  class="mr-2 mt-2"
                  text-color="white"
                ...
                <v-chip
                  v-if="currentCourse.third_course.fields.CI"
                  medium
                  color="black"
                  class="mr-2 mt-2"
                  text-color="white"
                ...
                <v-chip
                  v-if="currentCourse.third_course.fields.HI"
                  medium
                  color="#87AEE8"
                  class="mr-2 mt-2"
                  text-color="black"
                ...
                <v-chip
                  v-if="currentCourse.third_course.fields.DI"
                  medium
                  color="#ff63bc"
                  class="mr-2 mt-2"
                  text-color="black"
                ...
                <v-chip
                  v-if="currentCourse.third_course.fields.fall"
                  medium
                  color="#ff8247"
                  class="mr-2 mt-2"
                  text-color="black"
                ...
                <v-chip
                  v-if="currentCourse.third_course.fields.spring"
                  medium
                  color="#54ff7c"
                  class="mr-2 mt-2"
                  text-color="black"
                ...
                <v-chip
                  v-if="currentCourse.third_course.fields.summer"
                  medium
                  color="#ffeb54"
                  class="mr-2 mt-2"
                  text-color="black"
