    ...
    mutations: {
        initializeStore(state) {
            if (localStorage.getItem('options')) {
                try {
                    state.shoppingCart.options = JSON.parse(
        ...
        saveButton(state) {
            ...
            state.shoppingCart.options[state.count] = [
                state.currentSelection.pathway,
                JSON.parse(localStorage.getItem('course1')),
                JSON.parse(localStorage.getItem('course2')),
                JSON.parse(localStorage.getItem('course3')),
            ]
            state.count += 1
        ...
        removePath(state, i) {
            ...
            localStorage.setItem(
                'options',
                JSON.stringify(state.shoppingCart.options)
            )
        },
    },
    getters: {
